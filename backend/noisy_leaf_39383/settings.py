"""
Django settings for noisy_leaf_39383 project.
...
ROOT_URLCONF = 'noisy_leaf_39383.urls'
...
WSGI_APPLICATION = 'noisy_leaf_39383.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_leaf_39383 API",
    "DESCRIPTION": "API documentation for noisy_leaf_39383 App",
    "VERSION": "v1",
}
